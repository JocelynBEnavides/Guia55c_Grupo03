<%@page contentType="application/json" pageEncoding="UTF-8" import="java.sql.*,net.ucanaccess.jdbc.*, javax.servlet.*, javax.servlet.http.*"%>
...
<%
   ...
   if (!conexion.isClosed()){
    ...
    while (res.next()){
        ...
        out.println("   'titulo':'"+titu+"',");
        out.println("   'autor':'"+aut+"',");
        out.println("   'publicacion':'"+publica+"',");
        out.println("   'editorial':'"+edito+"'");
        out.println("  },");
      }
        out.println("]}");    
