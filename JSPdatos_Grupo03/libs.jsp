<%@page contentType="text/html" pageEncoding="iso-8859-1" import="java.sql.*,net.ucanaccess.jdbc.*" %>
    ...
    <body>
        ...
        <form>
            Titulo: <input onkeyup="validar()"  class="inputFormu" type="text" name="titulo"> &nbsp;&nbsp;
            Autor: <input onkeyup="validar()" class="inputFormu" type="text" name="Autor"/> 
            &nbsp;&nbsp;<input type="SUBMIT" id="btnbuscar" name="btnbuscar" value="BUSCAR"  disabled/>
      <td><a id="volver" href="libs.jsp">Volver</a></td>
        </form>
        <%!
...
Connection conexion = getConnection(path);
   if (!conexion.isClosed()){
    ...
    //Parte del Ejercicio 3
      ...
      try{
         if(orden.equals("ASC")){
            out.println("<table id=\"color\"><tr id=\"color\"><td>Num.</td><td>ISBN</td><td><a href='libs.jsp?orden=DESC'>T&iacute;tulo</a></td><td>Autor</td><td>A&ntilde;o de Publicaci&oacute;n</td><td>Editorial</td><td>Acci&oacute;n</td></tr>");
         }else{
            out.println("<table id=\"color\"><tr id=\"color\"><td>Num.</td><td>ISBN</td><td><a href='libs.jsp?orden=ASC'>T&iacute;tulo</a></td><td>Autor</td><td>A&ntilde;o de Publicaci&oacute;n</td><td>Editorial</td><td>Acci&oacute;n</td></tr>");
         }
      }
      catch(Exception e) {
         out.println("<table id=\"color\"><tr id=\"color\"><td>Num.</td><td>ISBN</td><td><a href='libs.jsp?orden=ASC'>T&iacute;tulo</a></td><td>Autor</td><td>A&ntilde;o de Publicaci&oacute;n</td><td>Editorial</td><td>Acci&oacute;n</td></tr>");
